...
"""
Fine-tuning the 🤗 library models for extractive question answering using a slightly adapted version of the 🤗 Trainer (in directory `qa_utils`).
"""
...
def main():
    ...
    if training_args.do_train:
        if "t5" in model_args.model_name_or_path:
            optimizer = Adafactor(model.parameters(), lr=training_args.learning_rate, weight_decay=0.01)
